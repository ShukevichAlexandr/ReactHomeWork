...
type EventTargetValueType = React.ChangeEvent<HTMLInputElement>
...
export const HW3 = () => {
  ...
  const handleChange = (event: EventTargetValueType) => {
  ...
  return (
    <div id={'hw03'}>
      ...
      <button style={{height: '22px', width: '100px'}} id={'hw03-button'} onClick={handleSave}>Add</button> 
